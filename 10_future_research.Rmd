...
```{r gantt-chart, fig.cap = "Gantt chart for current and future projects during my PhD.", out.width = ifelse(knitr:::is_latex_output(), ".75\\textheight", "100%"), out.extra = if (knitr:::is_latex_output()) {"angle = 90"}}
