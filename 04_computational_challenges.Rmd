...
\]
and this defines Monte Carlo integration. The variance of the estimated integral \(\hat{I}_{\Omega}\) follows, assuming the \(u_i\) are independenent, as
\[
V(\hat{I}_{\Omega}) = \frac{V(\Omega)^2}{N^2} N V(f(u_i)).
\]
More details in @monahan_2011.
