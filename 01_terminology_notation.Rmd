...
The survival function is the complement of the cumulative distribution function of the observed time \(T\) and represent the probability that a given individual survives (loosely speaking) longer than \(t\):
\[
