...
The notation presented in this Chapter follows @collett_2014, where further details can be found. Other seminal books covering the topic of survival analysis are @cox_1984, @kalbfleisch_2011, and @kleinbaum_2012. The hazard function \(h(t)\) and the survival function \(S(t)\) form building blocks for the models that I will be presenting in the following Sections \@ref(smre) and \@ref(jm) and it is crucial to keep their formulation and interpretation clear in mind.
